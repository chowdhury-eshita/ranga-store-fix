...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h4>Rating: <span class="font-bold">${product.rating.rate}</span></h4>
      <h4><span class="font-bold">${product.rating.count}</span> positive Reviews</h4>
...
//get innerText from field for calculation
