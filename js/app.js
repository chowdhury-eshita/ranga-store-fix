...
const getInputValue = (id) => {
  ...
  const converted = parseFloat(element); //bug parseInt
  return converted;
};
...
const updatePrice = (id, value) => {
  ...
  document.getElementById(id).innerText = total.toFixed(2); //bug 2 decimal precition fixed
};

// set innerText function
const setInnerText = (id, value) => {
  document.getElementById(id).innerText = value.toFixed(2); //bug 2 decimal precition fixed
};
